            ...
            {BLOG_NAVBAR_DATA.map((item, index) => {
              ...
              return (
                <li key={item.id}>
                  <Link
                    to={item.path}
                    className="relative group text-sm font-medium text-gray-800 tracking-wide"
                  >
                    {item.label}
                    <span
                      className={`absolute inset-x-0 -bottom-1 h-[2px] bg-sky-500 transition-transform duration-300 origin-left ${
